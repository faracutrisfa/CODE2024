    ...
    return (
        <section>
            <div className="text-secondary-50 mt-36 flex flex-col justify-center text-center mx-5 lg:mx-18">
                <h1 className="font-bold text-3xl leading-[38.40px] lg:text-6xl lg:leading-[72px] mb-2">Competition Procedures</h1>
                <h2 className="text-base font-bold leading-tight lg:text-3xl lg:leading-[38.40px]">There are 3 stages of CODE 2024</h2>
                ...
                <div className="gap-9 flex flex-col lg:mt-20 mt-10">
                    ...
                    <div className="border-4 border-secondary-50 rounded-[54px]">
                        <div className="border bg-secondary-50 text-primary-50 m-3 lg:m-5 rounded-[54px] p-10 lg:p-15 flex flex-col items-start text-start gap-4 lg:gap-0">
                            <h2 className="font-bold text-xl leading-normal lg:text-4xl lg:leading-[48px]">Extended Abstract Submission</h2>
                            <div className="font-normal text-xs leading-[14px] lg:text-3xl lg:leading-[38.40px] flex flex-col gap-3 lg:gap-0">
                                <li>Participants are required to pay the extended abstract registration fee after being declared to have passed the abstract stage.</li>
                                <li>Participants can see the requirements for writing extended abstracts in the guidebook contained in the sub-writing requirements.</li>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-4 border-secondary-50 rounded-[54px]">
                        <div className="border bg-secondary-50 text-primary-50 m-3 lg:m-5 rounded-[54px] p-10 lg:p-15 flex flex-col items-start text-start gap-4 lg:gap-0">
                            <h2 className="font-bold text-xl leading-normal lg:text-4xl lg:leading-[48px]">Final Pitching</h2>
                            <div className="font-normal text-xs leading-[14px] lg:text-3xl lg:leading-[38.40px] flex flex-col gap-3 lg:gap-0">
                                <li>Participants who become finalists must submit posters and powerpoints according to the specified time</li>
                                <li>Participants can see the poster format requirements in the guidebook contained in the poster sub-requirements.</li>
                            </div>
                        </div>
                    </div>
                </div>
