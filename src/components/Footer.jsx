...
export default function Footer() {
    ...
    return (
        <footer className="px-5 lg:px-18 py-10 bg-secondary-90 w-full text-primary-50">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:mb-40 mb-20 gap-10 lg:gap-0 justify-center items-center text-center lg:items-start lg:text-start">
                ...
                <ul>
                    ...
                    <div className="text-sm lg:text-base font-medium leading-tight font-Metropolis gap-4 flex flex-col">
                        ...
                        <Link to="/Register" onClick={handleLinkClick}><li>Register Now</li></Link>
                        <Link to="https://wa.me/6282332648369" target="_blank" onClick={handleLinkClick}><li>Contact Us</li></Link>
                        <Link to="https://www.instagram.com/code.ub/" target="_blank" onClick={handleLinkClick}><li>FAQ</li></Link>
                    </div>
                </ul>
                <div>
                    ...
                    <div className="text-sm lg:text-base font-medium leading-tight font-Metropolis flex flex-col gap-4">
                        <a href="https://wa.me/6282332648369" target="_blank">Contact 1: +62 823-3264-8369</a>
                        <a href="https://wa.me/6283119411817" target="_blank">Contact 2: +62 831-1941-1817</a>
                    </div>
                </div>
                <div>
                    <h1 className="font-bold text-2xl leading-7 mb-4">Social Media</h1>
                    <div className="flex gap-3">
                        <a href="https://www.instagram.com/code.ub/" target="_blank" className="border rounded-full bg-secondary-10 border-secondary-10 p-1"><FaInstagram size={24} /></a>
