  ...
  return (
    <section className="mx-5 lg:mx-18 py-20 lg:py-20">
      <div className="text-primary-50 flex flex-col items-center justify-center py-8 lg:py-18 border bg-secondary-50 rounded-[32px] lg:rounded-[54px]">
        <h1
          className="font-bold tracking-wide text-2xl leading-[38.40px] md:text-5xl xl:text-6xl lg:leading-[72px] mb-8 lg:mb-12"
          data-aos="zoom-in"
          data-aos-duration="800"
          data-aos-easing="ease-out"
        >
          Registrant Procedure
        </h1>
        <div className="hidden sm:block">
          <div className="flex flex-col items-center">
            <img
              src={Procedure1}
              className="mb-10 w-[90%] xl:w-[100%] transition-transform duration-300 ease-in-out hover:translate-y-[-10px]"
              alt="Procedure 1"
            />
            <img
              src={Procedure2}
            ...
            <img
              src={Procedure3}
              className="mb-0 w-[90%] xl:w-[100%] transition-transform duration-300 ease-in-out hover:translate-y-[-10px]"
              alt="Procedure 3"
            />
          </div>
        </div>
        ...
        <div className="block sm:hidden">
          <img
            src={Procedure1A}
            className="mb-8 transition-transform duration-300 ease-in-out hover:translate-y-[-10px]"
            alt="Procedure 1A"
          />
          <img
            src={Procedure2A}
